...
func (o *options) Parse() error {
	...
	flagSet.StringVar(&o.input, "input", o.i, "input filename")
	flagSet.StringVar(&o.o, "o", o.o, "output filename")
	flagSet.StringVar(&o.output, "output", o.o, "output filename")
	flagSet.StringVar(&o.db, "db", o.db, "database name")
	flagSet.StringVar(&o.database, "database", o.db, "database name")
